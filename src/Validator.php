            ...
            if (false === $result) {
                ...
                if (!empty($msg[$i])) {
                    ...
                    if (is_string($message) && strpos($message, '{%') === 0) {
                        $message = Lang::t(substr($message, 2, -1));
                    }
                } else {
...
//                break;
    ...
    {
        return strtoupper($rule) == strtoupper(Request::method());
    }
...
//            $length = $value->getSize();
    ...
    protected function getRuleMsg($attribute, $title, $type, $rule)
    {
        if (isset($this->message[$attribute . '.' . $type])) {
            ...
            $msg = $title . Lang::t('not conform to the rules');
        }
